...
def create_scaling_data(world: "PokemonVegaWorld"):
    ...
    kanto_trainer_data = {
        "Professor Holly's Lab": [{"name": "Holly's Lab Rival",
                                   "data_ids": ["TRAINER_RIVAL_HOLLYS_LAB_NIMBLEAF", "TRAINER_RIVAL_HOLLYS_LAB_PEYERO",
        ...
        "Route 502 Gatehouse 2F": [{"name": "School Kid Vivian", "data_ids": ["TRAINER_SCHOOL KID_VIVIAN"]},
                                   {"name": "Youngster Vincent", "data_ids": ["TRAINER_YOUNGSTER_VINCENT"]},
                                   {"name": "Lass Violet", "data_ids": ["TRAINER_LASS_VIOLET"]},
                                   {"name": "School Kid Vivian Rematch", "data_ids": ["TRAINER_SCHOOL KID_VIVIAN_2"]},
                                   {"name": "Youngster Vincent Rematch", "data_ids": ["TRAINER_YOUNGSTER_VINCENT_2"]},
                                   {"name": "Lass Violet Rematch", "data_ids": ["TRAINER_LASS_VIOLET_2"]}],
        "Junopsis Gym": [{"name": "Junopsis Gym Trainers", "data_ids": ["TRAINER_LASS_IRIS", "TRAINER_GYM_LEADER_ANNETTE"]}],
        "Route 503 North": [{"name": "Youngster Calvin", "data_ids": ["TRAINER_YOUNGSTER_CALVIN"]},
                            {"name": "Camper Liam", "data_ids": ["TRAINER_CAMPER_LIAM"]},
                            {"name": "Picnicker Diana", "data_ids": ["TRAINER_PICNICKER_DIANA"]},
                            {"name": "Twins Ann & Anne", "data_ids": ["TRAINER_TWINS_ANN_ANNE"]},
                            {"name": "Bug Catcher Rick", "data_ids": ["TRAINER_BUG_CATCHER_RICK"]},
                            {"name": "Hiker Clark", "data_ids": ["TRAINER_HIKER_CLARK"]},
                            {"name": "Rich Boy Everett", "data_ids": ["TRAINER_RICH_BOY_EVERETT"]},
                            {"name": "Lady Jacki", "data_ids": ["TRAINER_LADY_JACKI"]},
                            {"name": "Lass Miriam", "data_ids": ["TRAINER_LASS_MIRIAM"]},
                            {"name": "School Kid Olivia", "data_ids": ["TRAINER_SCHOOL_KID_OLIVIA"]},
                            {"name": "Hiker Brice", "data_ids": ["TRAINER_HIKER_BRICE"]}],
        "Route 503 South": [{"name": "School Kid Fabian", "data_ids": ["TRAINER_SCHOOL_KID_FABIAN"]}],
        "Wiseman's Cave B1F East": [{"name": "Team DH Grunt 60", "data_ids": ["TRAINER_TEAM_DH_GRUNT_60"]},
                                    {"name": "Team DH Grunt 61", "data_ids": ["TRAINER_TEAM_DH_GRUNT_61"]},
                                    {"name": "Team DH Grunt 62", "data_ids": ["TRAINER_TEAM_DH_GRUNT_62"]},
                                    {"name": "Team DH Grunt 77", "data_ids": ["TRAINER_TEAM_DH_GRUNT_77"]}],
        "Wiseman's Cave B1F West": [{"name": "Team DH Grunt 68", "data_ids": ["TRAINER_TEAM_DH_GRUNT_68"]}],
        "Wiseman's Cave B2F Southeast": [{"name": "Pokemon Ranger Jackson", "data_ids": ["TRAINER_PKMN_RANGER_JACKSON"]},
                                         {"name": "Hiker Wayne", "data_ids": ["TRAINER_HIKER_WAYNE"]},
                                         {"name": "Battle Girl Jocelyn", "data_ids": ["TRAINER_BATTLE_GIRL_JOCELYN"]},
                                         {"name": "Hiker Quincy", "data_ids": ["TRAINER_HIKER_QUINCY"]}],
        "Wiseman's Cave B2F Southwest": [{"name": "Black Belt Hideki", "data_ids": ["TRAINER_BLACK_BELT_HIDEKI"]},
                                         {"name": "Expert Auron", "data_ids": ["TRAINER_EXPERT_AURON"]}],
        "Wiseman's Cave B2F East": [{"name": "Poke Maniac Mark", "data_ids": ["TRAINER_POKE_MANIAC_MARK_REWARD"]}],
        "Wiseman's Cave B2F North": [{"name": "Pokemon Breeder Miles", "data_ids": ["TRAINER_PKMN_BREEDER_MILES"]},
                                     {"name": "Crush Kin Ron & Mia", "data_ids": ["TRAINER_CRUSH_KIN_RON_MIA"]},
                                     {"name": "Ace Trainer Harrison", "data_ids": ["TRAINER_ACE_TRAINER_HARRISON"]},
                                     {"name": "Ace Trainer Caroline", "data_ids": ["TRAINER_ACE_TRAINER_CAROLINE"]}],
        "Wiseman's Cave B2F Northwest": [{"name": "Gym Leader Avery Rematch", "data_ids": ["TRAINER_GYM_LEADER_AVERY_4_REWARD"]}],
        "Route 504": [{"name": "Youngster Joey", "data_ids": ["TRAINER_YOUNGSTER_JOEY"]},
                      {"name": "Hiker Trent", "data_ids": ["TRAINER_HIKER_TRENT"]},
                      {"name": "Bug Catcher Doug", "data_ids": ["TRAINER_BUG_CATCHER_DOUG"]},
                      {"name": "Skier Mason", "data_ids": ["TRAINER_SKIER_MASON"]},
                      {"name": "Aroma Lady Nikki", "data_ids": ["TRAINER_AROMA_LADY_NIKKI"]},
                      {"name": "Poke Fan Colin", "data_ids": ["TRAINER_POKE_FAN_COLIN"]},
                      {"name": "Poke Fan Linda", "data_ids": ["TRAINER_POKE_FAN_LINDA"]},
                      {"name": "Skier Lydia", "data_ids": ["TRAINER_SKIER_LYDIA"]}],
        "Route 505": [{"name": "Pokemon Breeder Cory", "data_ids": ["TRAINER_PKMN_BREEDER_CORY"]},
                      {"name": "Teammates Sara & Ivy", "data_ids": ["TRAINER_TEAMMATES_SARA_IVY"]},
                      {"name": "Skier Lisa", "data_ids": ["TRAINER_SKIER_LISA"]},
                      {"name": "Teammates Kate & Joy", "data_ids": ["TRAINER_TEAMMATES_KATE_JOY"]}],
        "Seafin City": [{"name": "Seafin City Rival",
                         "data_ids": ["TRAINER_RIVAL_SEAFIN_NIMBLEAF", "TRAINER_RIVAL_SEAFIN_PEYERO",
                                      "TRAINER_RIVAL_SEAFIN_LIQUIPUT"]}],
        "Seafin Gym": [{"name": "Seafin Gym Trainers",
                        "data_ids": ["TRAINER_CAMPER_DREW", "TRAINER_HIKER_DUDLEY", "TRAINER_YOUNGSTER_TYLER",
                                     "TRAINER_GYM_LEADER_GEOFF"]}],
        "Spirit Mansion 1F": [{"name": "Burglar Quinn", "data_ids": ["TRAINER_BURGLAR_QUINN"]},
                              {"name": "Collector Julio", "data_ids": ["TRAINER_COLLECTOR_JULIO"]}],
        "Spirit Mansion 1F Southeast": [{"name": "Super Nerd Miguel", "data_ids": ["TRAINER_SUPER_NERD_MIGUEL"]}],
        "Spirit Mansion 2F Southwest": [{"name": "Engineer Braxton", "data_ids": ["TRAINER_ENGINEER_BRAXTON"]}],
        "Spirit Mansion 2F Northeast": [{"name": "Super Nerd Jovan", "data_ids": ["TRAINER_SUPER_NERD_JOVAN"]}],
        "Spirit Mansion B1F": [{"name": "Collector Wade", "data_ids": ["TRAINER_COLLECTOR_WADE"]},
                               {"name": "Young Couple Gia & Jes", "data_ids": ["TRAINER_YOUNG_COUPLE_GIA_JES"]},
                               {"name": "Gambler Hugo", "data_ids": ["TRAINER_GAMBLER_HUGO"]},
                               {"name": "Engineer Baily", "data_ids": ["TRAINER_ENGINEER_BAILY"]},
                               {"name": "Pokemon Ranger Madeline", "data_ids": ["TRAINER_PKMN_RANGER_MADELINE"]},
                               {"name": "Teammates Anna & Meg", "data_ids": ["TRAINER_TEAMMATES_ANNA_MEG"]},
                               {"name": "Gym Leader Geoff Rematch", "data_ids": ["TRAINER_GYM_LEADER_GEOFF_4"]}],
        "Route 506": [{"name": "Camper Ricky", "data_ids": ["TRAINER_CAMPER_RICKY"]},
                      {"name": "Picnicker Isabelle", "data_ids": ["TRAINER_PICNICKER_ISABELLE"]},
                      {"name": "Poke Fan Kaleb", "data_ids": ["TRAINER_POKE_FAN_KALEB"]},
                      {"name": "Poke Fan Donna", "data_ids": ["TRAINER_POKE_FAN_DONNA"]},
                      {"name": "Aroma Lady Janice", "data_ids": ["TRAINER_AROMA_LADY_JANICE"]},
                      {"name": "Skier Tammy", "data_ids": ["TRAINER_SKIER_TAMMY"]},
    ...
    kanto_wild_encounter_data = {
        ...
        "Route 503 Land Encounters": [{"name": "Route 503 Land Scaling", "type": "Land", "data_ids": ["MAP_ROUTE503"]}],
        "Wiseman's Cave B1F Land Encounters": [{"name": "Wiseman's Cave B1F Land Scaling", "type": "Land",
                                         "data_ids": ["MAP_WISEMANS_CAVE_B1F"]}],
        "Wiseman's Cave B2F Land Encounters": [{"name": "Wiseman's Cave B2F Land Scaling", "type": "Land",
                                          "data_ids": ["MAP_WISEMANS_CAVE_B2F"]}],
        "Route 504 Land Encounters": [{"name": "Route 504 Land Scaling", "type": "Land", "data_ids": ["MAP_ROUTE504"]}],
        "Route 505 Land Encounters": [{"name": "Route 505 Land Scaling", "type": "Land", "data_ids": ["MAP_ROUTE505"]}],
        "Spirit Mansion 1F Land Encounters": [{"name": "Spirit Mansion 1F Land Scaling", "type": "Land",
                                               "data_ids": ["MAP_SPIRIT_MANSION_1F"]}],
        "Spirit Mansion 2F Land Encounters": [{"name": "Spirit Mansion 2F Land Scaling", "type": "Land",
                                               "data_ids": ["MAP_SPIRIT_MANSION_2F"]}],
        "Spirit Mansion B1F Land Encounters": [{"name": "Spirit Mansion B1F Land Scaling", "type": "Land",
                                               "data_ids": ["MAP_SPIRIT_MANSION_B1F"]}],
        "Route 506 Land Encounters": [{"name": "Route 506 Land Scaling", "type": "Land", "data_ids": ["MAP_ROUTE506"]}],
    ...
    kanto_static_encounter_data = {
        "Route 502 Gatehouse 2F": [{"name": "Gift Bulbasaur", "data_ids": ["GIFT_POKEMON_BULBASAUR"]},
                                   {"name": "Gift Charmander", "data_ids": ["GIFT_POKEMON_CHARMANDER"]},
                                   {"name": "Gift Squirtle", "data_ids": ["GIFT_POKEMON_SQUIRTLE"]}],
...
def level_scaling(multiworld):
    ...
    battle_events = ["Route 502 Gatehouse 2F - Winstrate Siblings Battles", "Junopsis Gym - Gym Leader Battle",
                     "Seafin Gym - Gym Leader Battle", "Gamboge Gym - Gym Leader Battle",
                     "Nephrite Gym - Gym Leader Battle", "Orpimence Gym - Gym Leader Battle",
                     "Ravenplume Gym - Gym Leader Battle", "Lapizula Gym - Gym Leader Battle",
                     "New Island Gym - Gym Leader Battle", "Champion's Room - Champion Battle",
                     "Porcelia Forest West - Gym Leader Annette Rematch", "Spirit Mansion B1F - Gym Leader Geoff Rematch",
                     "Undersea Tunnel B3F - Gym Leader Brooke Rematch", "Wiseman's Cave B2F - Gym Leader Avery Rematch",
                     "Tower of Darkness B2F - Gym Leaders Chie & Rito Rematch", "Mt. Snowfall B2F - Gym Leader Fenton Rematch",
                     "DH Hideout B6F - Gym Leader Tara Rematch", "Pokemon Castle 8F - Gym Leader Francis Battle",
                     "Pokemon Tower 7F - Hostage", "Silph Co. 11F - Giovanni Battle",
                     "Berry Forest - Hypno Battle", "Icefall Cave Back - Team Rocket Grunt Battle"]
